                    ...
                    <template #default>
                        <TableRow v-for="role in roles" :key="role.id" class="border-b">
                            ...
                            <TableDataCell class="space-x-4">
                                <Link :href="route('roles.edit', role.id)" class="text-green-400 hover-green-600">Edit</Link>
                                <button @click="confirmDeleteRole" class="text-red-400 hover-red-600">Delete</button>
